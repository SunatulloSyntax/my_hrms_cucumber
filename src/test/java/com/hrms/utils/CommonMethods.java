...
public class CommonMethods extends PageInitializer{
	...
	/**
	 * This method will take screenshot of specified area 
	 * @param path
	 * @param destination
	 */
	public static void takeScreenShotsScecificArea(String path, String fileName) {
		WebElement specificSpace = driver.findElement(By.xpath(path));
		TakesScreenshot ts = (TakesScreenshot)specificSpace;
		File file = ts.getScreenshotAs(OutputType.FILE);
		try {
...
//----------------------------------------------------------------------------------
	 ...
	 * 
	 * @throws NoAlertException if alert is not present
	 */
	...
	/**
	 * This method will wait untill element becomes invisible
	 * @param element
	 */
